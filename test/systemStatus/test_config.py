...
DEFAULT_MON_PATH = f"{HOME_PATH}/.systemStatus"
FILE_MON_PATH = "/tmp/systemStatus"
TEST_CONFIG_PATH = "test/files/systemStatusConfig.yaml"
...
def test_config_default_creation():
    ...
    assert testConfig.report_path() == DEFAULT_MON_PATH
...
def test_read_config_from_file():
    ...
    assert testConfig.report_path() == FILE_MON_PATH
